...
cell_func:
  ...
  mov eax, 0
  mov ecx, 0
  print dword[ebp+12],FORMAT_INT
  print dword[ebp+8],FORMAT_INT

  ; check top left neigbor
  mov al, byte[ebp+12]     ; get y
  cmp al, 0
  jne .top_left     ; if y=0 top neigbor is in to bottom row
